...
from qiita_pet.handlers.api_proxy.custom_study_api import (
    StudyDetailAPIHandler,
    StudyAuthorsAPIHandler, 
    StudyAbstractAPIHandler
)
...
class Application(tornado.web.Application):
    def __init__(self):
        handlers = [
            ...
            # Custom Study API Handlers
            (r"/api/v1/study/([0-9]+)/details/?", StudyDetailAPIHandler),
            (r"/api/v1/study/([0-9]+)/authors/?", StudyAuthorsAPIHandler),
            (r"/api/v1/study/([0-9]+)/abstract/?", StudyAbstractAPIHandler),
        ]
